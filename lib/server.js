...
Server.prototype.grant = function (type, phase, fn) {
  if (typeof type == 'object') {
    ...
    if (mod.error) {
      this.grant(mod.name, 'error', mod.error);
    }
    return this;
  }
  if (typeof phase == 'object') {
    ...
    if (mod.error) {
      this.grant(type, 'error', mod.error);
    }
    return this;
  }
 ...
 * @api public
 */
Server.prototype.authorize = Server.prototype.authorization = function (
  options,
  validate,
  immediate,
  complete
...
Server.prototype.authorizeError =
  ...
  Server.prototype.authorizationErrorHandler =
  function (options) {
